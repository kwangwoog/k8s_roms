      MODULE lmd_bkpp_mod
!
!svn $Id: lmd_bkpp.F 778 2015-08-22 01:20:04Z arango $
!================================================== Hernan G. Arango ===
!  Copyright (c) 2002-2015 The ROMS/TOMS Group       Scott M. Durski   !
...
!-----------------------------------------------------------------------
!$acc data create(zgrid) copyin(z_w)
      DO k=0,N(ng)
!$acc parallel loop 
        DO j=Jstr,Jend
          DO i=Istr,Iend
