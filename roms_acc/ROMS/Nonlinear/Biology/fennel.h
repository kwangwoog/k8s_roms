...
!
!svn $Id: fennel.h 762 2015-06-23 20:17:58Z arango $
!***********************************************************************
...
#endif
#ifdef PO4_TAK
		real(r8), parameter :: K_PO4 = 2.0_r8         ! half-saturation for phytoplankton PO4 uptake
		real(r8), parameter :: NPratio = 0.0625_r8      ! NPratio in organism
		real(r8) :: L_PO4, LMIN, mu, cff6,newPO4
#endif		
...
!
                ...
                LTOT=L_NO3+L_NH4
#ifdef PO4_TAK
					 cff3=Bio(i,k,itPO4)*K_PO4/NPratio
...
!
                ...
                fac1=dtdays*t_PPmax
					 IF (LMIN .lt. LTOT) THEN                        !phosphate limitation environment
		      	  	cff4=fac1*L_PO4*(K_NO3(ng)*inhNH4/(1.0_r8+cff2)/      &
     &             LTOT)*Bio(i,k,iPhyt)
	               cff5=fac1*L_PO4*(K_NH4(ng)/(1.0_r8+cff1)/LTOT)*       &
     &            Bio(i,k,iPhyt)
	  					cff6=fac1*K_PO4/(1.0_r8+cff3)*Bio(i,k,iPhyt)   ! phosphate consumption in phosphate limiation
					 ELSE
					  cff4=fac1*K_NO3(ng)*inhNH4/(1.0_r8+cff2)*Bio(i,k,iPhyt)
                 cff5=fac1*K_NH4(ng)/(1.0_r8+cff1)*Bio(i,k,iPhyt)
	              cff6=fac1*LTOT*Bio(i,k,iPhyt)
					 END IF
#else
					 fac1=dtdays*t_PPmax
					 cff4=fac1*K_NO3(ng)*inhNH4/(1.0_r8+cff2)*Bio(i,k,iPhyt)
...
#ifdef PO4_TAK
					 IF (LMIN .lt. LTOT) THEN
					 	Bio(i,k,itPO4)=Bio(i,k,itPO4)/(1.0_r8+cff6)
					 ELSE
					 	newPO4=Bio(i,k,itPO4)-cff6
					   IF (newPO4 .gt. 0.0_r8) THEN
							Bio(i,k,itPO4)=newPO4
						ELSE
							Bio(i,k,itPO4)=0.0_r8
						END IF
					 END IF
#endif
...
#ifdef PO4_TAK
				  Bio(i,k,itPO4)=Bio(i,k,itPO4)+NPratio*N_Flux_Zexcret
#endif
...
#ifdef PO4_TAK
				   Bio(i,k,itPO4)=Bio(i,k,itPO4)+NPratio*N_Flux_Zmetabo
#endif
#ifdef OXYGEN
              Bio(i,k,iOxyg)=Bio(i,k,iOxyg)-                            &
...
# ifdef PO4_TAK
              Bio(i,k,itPO4)=Bio(i,k,itPO4)+NPratio*N_Flux_Remine
# endif
...
#  endif
#  ifdef OXYGEN
				 oxygen1=Bio(i,1,iOxyg)-cff1*cff3
				 IF (oxygen1 .gt. 0.0_r8) THEN
					 Bio(i,1,iNH4_)=Bio(i,1,iNH4_)+cff1*cff2
					 Bio(i,1,iOxyg)=oxygen1
				 ELSE
					 Bio(i,1,iOxyg)=0.0_r8
				 END IF
#  ifdef PO4_TAK
	  				oxygen1=Bio(i,1,iOxyg)-cff1*cff3
					IF (oxygen1 .gt. 0.0_r8) THEN
					   Bio(i,1,itPO4)=Bio(i,1,itPO4)+cff1
					END IF
#  endif
...
!                Bio(i,1,iOxyg)=Bio(i,1,iOxyg)-cff1*cff4
					 oxygen1=Bio(i,1,iOxyg)-cff1*cff4
					 IF (oxygen1 .gt. 0.0_r8) THEN
					    Bio(i,1,iOxyg)=oxygen1
					 ELSE
					 	 Bio(i,1,iOxyg)=0.0_r8
