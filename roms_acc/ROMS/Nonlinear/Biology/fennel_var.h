...
#ifdef PO4_TAK
              CASE ('idTbry(iwest,itPO4)')
                idTbry(iwest,itPO4)=varid
              CASE ('idTbry(ieast,itPO4)')
                idTbry(ieast,itPO4)=varid
              CASE ('idTbry(isouth,itPO4)')
                idTbry(isouth,itPO4)=varid
              CASE ('idTbry(inorth,itPO4)')
                idTbry(inorth,itPO4)=varid
